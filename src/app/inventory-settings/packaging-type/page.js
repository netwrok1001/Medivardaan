  ...
  return (
    <div className="p-6 bg-white dark:bg-[#18122B] min-h-screen space-y-6">
      <div className="flex items-center gap-2 border-b border-gray-200 dark:border-[#443C68]/50 pb-4">
        ...
        <h1 className="text-lg font-bold text-medivardaan-teal dark:text-medivardaan-purple uppercase tracking-wide">PACKAGING TYPE</h1>
      </div>
      ...
      {isView === "list" ? (
        ...
        <div className="bg-white dark:bg-[#393053] p-6 rounded-lg shadow-sm space-y-6 max-w-2xl mx-auto">
           <div className="space-y-4">
               <h3 className="font-bold text-primary border-b pb-2 uppercase">{editingId ? 'Edit Packaging Type' : 'Add New Packaging Type'}</h3>
