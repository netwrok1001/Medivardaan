  ...
  return (
    <div className="p-6 space-y-6 min-h-screen bg-gray-50/50 dark:bg-[#18122B] transition-colors duration-200">
      ...
      <div className="flex items-center text-sm text-muted-foreground mb-4">
        ...
        <span className="text-foreground font-medium dark:text-white/90">Non Converted Enquiry</span>
      </div>
        ...
        <Table>
          <TableHeader className="bg-primary/20 dark:bg-[#635985]/20">
            <TableRow className="dark:border-[#443C68]/50">
              ...
              <TableHead className="font-bold text-[#0f7396] dark:text-[#635985]">Email</TableHead>
              <TableHead className="font-bold text-[#0f7396] dark:text-[#635985]">Date</TableHead>
            ...
            {data.length === 0 ? (
              ...
              data.map((item, idx) => (
                <TableRow key={idx} className="hover:bg-gray-50 dark:bg-[#18122B]/50 dark:hover:bg-[#393053]/50 dark:border-[#443C68]/50">
                  ...
                  <TableCell className="dark:text-white/75">{item.email}</TableCell>
