        ...
        <Card className="border border-gray-200 dark:border-[#443C68]/50 shadow-sm bg-white dark:bg-[#18122B]">
            <CardContent className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    ...
                    <Label className="text-sm font-medium text-foreground/80 dark:text-white/75">Visitor Name</Label>
                    <Input
                ...
                <TableWrapper>
                    ...
                    <thead>
                        ...
                        <th className="px-4 py-3 text-left text-sm font-medium text-gray-700 dark:text-white/90">Date</th>
                        <th className="px-4 py-3 text-left text-sm font-medium text-gray-700 dark:text-white/90">Time</th>
                        <th className="px-4 py-3 text-center text-sm font-medium text-gray-700 dark:text-white/90">Status</th>
                        <th className="px-4 py-3 text-center text-sm font-medium text-gray-700 dark:text-white/90">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
